...
In order to support loading of multiple wallets in clonecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is clonecoin.cpp.
...
Changes to clonecoin.cpp
----------------------
clonecoin.cpp is the entry point into clonecoin-qt, and as such, will require some minor modifications to provide hooks for
