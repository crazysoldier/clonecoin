...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CCoin Core"),
     ...
     * override -datadir in the clonecoin.conf file in the default data directory
     * (to be consistent with clonecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
