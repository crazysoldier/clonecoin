                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and clonecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CCoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the CCoin Core help message to get a list with possible CCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("CCoin Core"); // default title
