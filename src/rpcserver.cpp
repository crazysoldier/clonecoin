...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Clonecoin features */
        {"clonecoin", "masternode", &masternode, true, true, false},
        {"clonecoin", "masternodelist", &masternodelist, true, true, false},
        {"clonecoin", "mnbudget", &mnbudget, true, true, false},
        {"clonecoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"clonecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"clonecoin", "mnsync", &mnsync, true, true, false},
        {"clonecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"clonecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use clonecoind, or the -server option to clonecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> clonecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:56699/\n";
}
