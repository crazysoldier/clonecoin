...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Clonecoin Core clonecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  clonecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded clonecoin transaction") + "\n" +
                               "  clonecoin-tx [options] -create [commands]   " + _("Create hex-encoded clonecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded clonecoin transaction
