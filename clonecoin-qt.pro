...
RESOURCES += src/qt/clonecoin.qrc src/qt/clonecoin_locale.qrc

TRANSLATIONS += src/qt/locale/clonecoin_bg.ts \
                src/qt/locale/clonecoin_de.ts \
                src/qt/locale/clonecoin_en.ts \
                src/qt/locale/clonecoin_es.ts \
                src/qt/locale/clonecoin_fi.ts \
                src/qt/locale/clonecoin_fr.ts \
                src/qt/locale/clonecoin_it.ts \
                src/qt/locale/clonecoin_ja.ts \
                src/qt/locale/clonecoin_pl.ts \
                src/qt/locale/clonecoin_pt.ts \
                src/qt/locale/clonecoin_ru.ts \
                src/qt/locale/clonecoin_sk.ts \
                src/qt/locale/clonecoin_sv.ts \
                src/qt/locale/clonecoin_vi.ts \
                src/qt/locale/clonecoin_zh_CN.ts \
                src/qt/locale/clonecoin_zh_TW.ts
